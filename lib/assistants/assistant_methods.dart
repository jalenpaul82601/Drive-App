...
import 'package:untitled/models/direction_details_info.dart';
import 'package:untitled/models/directions.dart';
import 'package:untitled/models/trips_history_model.dart';
...
class AssistantMethods
{
  ...
  {
    String apiUrl = "https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.latitude}, ${position.longitude}&key=$andKey";
  ...
  static void readCurrentOnlineUserInfo()
  {
    ...
    {
      if(snap.snapshot.value != null) // if it contains data get user model from snapshot. Get current user info
        {
  ...
  {
    String urlOriginToDestinationDirectionDetails = "https://maps.googleapis.com/maps/api/directions/json?origin=${originPosition.latitude}, ${originPosition.longitude}&destination=${destinationPosition.latitude}, ${destinationPosition.longitude}&key=$andKey";
  ...
  //retrieve trips keys for online user
